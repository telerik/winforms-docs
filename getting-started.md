...
## Installing Telerik UI for for WinForms
The following article provides step-by-step instructions how to install Telerik UI for for WinForms on your computer: [Installing UI for WinForms](http://docs.telerik.com/devtools/winforms/installation-deployment-and-distribution/installing-on-your-computer)
...
At the following link you can find more information about the [Telerik UI for for WinForms integration with Visual Studio] (http://docs.telerik.com/devtools/winforms/installation-deployment-and-distribution/visual-studio-extensions/overview)
...
If you are new to the Windows Forms world and/or the Telerik UI for for WinForms product, a good place to start is our [step-by-step pdf tutorial](http://www.telerik.com/winforms/winforms-guide), which contains over 750 pages of training material, as well as plenty of code samples.

## Getting started articles

Below are listed the *Getting Started* help articles for most of the controls in the Telerik UI for for WinForms suite:
...
## Convert your existing Windows Forms applications to Telerik UI for for WinForms
The product also features a tool that aids the conversion process of applications using the standard Microsoft Windows Forms controls to their Telerik UI for for WinForms counterparts. See [Converter Tool page](http://docs.telerik.com/devtools/winforms/winforms-converter/overview) for more information.
...
## Product pages
Here you can find the [Telerik UI for for WinForms](http://www.telerik.com/products/winforms) product pages.
