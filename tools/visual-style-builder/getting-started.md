...
|[Styling Basics with Visual Style Builder for WinForms](http://tv.telerik.com/watch/winforms/visualstylebuilder/styling-basics-with-visual-style-builder-winforms)<br>In this video, you will learn how to create a basic theme using repositories in Visual Style Builder for WinForms. You will then learn how to use this theme in your Telerik UI for for WinForms based applications. (Runtime: 09:12)|![tools-visual-style-builder-getting-started 0016](images/tools-visual-style-builder-getting-started0016.png)|
