...
As of __Q1 2015__, the __Telerik UI for for WinForms__ suite uses the standard .NET licensing mechanism, which means that using the controls in design-time causes Visual Studio to add a __license.licx__ file to the solution. This file is used only in design-mode and is not needed for deployment.
