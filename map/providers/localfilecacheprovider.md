---
title: LocalFileCacheProvider
page_title: LocalFileCacheProvider | RadMap
...
The __LocalFileCacheProvider__ is a provider which doesn't connect to any real imagery services. It is used by an __IMapTileProvider__ to allow data caching and improve performance. The LocalFileCacheProvider.__CacheDirectoryPath__ property gets or sets the cache directory path. 
