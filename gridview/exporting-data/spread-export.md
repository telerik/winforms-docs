---
title: Spread export 
page_title: Spread export 
description: Spread export 
slug: gridview-exporting-data-spread-export
tags: spread,export,
published: True
position: 1
---
...
SpreadExport for RadGridView, utilizes our [RadSpreadProcessing]({%slug spreadprocessing-overview%})
...
>The SpreadExport export functionality is located in the __TelerikExport.dll__ assembly.
...
>MS Excel does not support other ways of hiding a column/row different from setting its width to zero. To avoid including hidden
            columns or rows in the exported excel file you could set __HiddenColumnOption__ or
            __HiddenRowOption__ property to *DoNotExport*:
...
* *CellSelection* - provides access to the excel cells selection. More information about the abilities this
              object introduces, can be found here: [Get, Set and Clear Cell Properties]({%slug spreadprocessing-working-with-cells-get-set-clear-properties%})
