...
1. Create a class for the cell which derives from __GridDataCellElement__:#__
...
1. Create the __RadProgressBarElement__ and add it as a child of the custom cell.
		  You can achieve this by overriding the __CreateChildElements__ method:#__
...
1. Override the __SetContentCore__ method to update the progress bar according to the cell value:#__
...
1. The custom cell will have no styles, because there are no defined styles for its type in the themes. 
		  You can apply the __GridDataCellElement’s__ styles to it by defining its __ThemeEffectiveType__:#__
...
1. Lastly, we need to add the custom column to our grid. #__
...
1. Initialize and add the elements to the cell:#__
...
1. Override the __ArrangeOverride__ method to arrange the children elements of the cell:#__
...
1. Handle the __Click__ event of __RadButtonElement__:#__
