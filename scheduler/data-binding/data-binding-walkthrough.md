...
>note The data source fields should be set prior editing the mapping in order to get automatically populated
            with data source fields drop downs.
>


>note The Resources property of the AppointmentMappingInfo should be set with the name of the relation
...
To retrieve the data, first we need to fill the data set:#_[C#]_
...
>note You should fill the tables in the exact same order if you have already set the DataSource property of RadScheduler.
...
Finally, we assign our SchedulerBindingDataSource instance to RadScheduler as its DataSource.
        ...
        ![scheduler-data-binding-data-binding-walkthrough 008](images/scheduler-data-binding-data-binding-walkthrough008.png)#_[C#]_
...
>note If the above steps are not performed in the same order, RadScheduler might not display the appointments.
