...
The work days determine the start and end days for the work week. All days outside the work days range are part of the weekend.#_[C#]_
...
## Getting the week days displayed#_[C#]_
...
It is possible to indicate whether the month view should always display exactly one month with the respective number of weeks.#_[C#]_
...
## Showing/hiding the vertical navigator#_[C#]_
...
## Setting the vertical navigator range#_[C#]_
