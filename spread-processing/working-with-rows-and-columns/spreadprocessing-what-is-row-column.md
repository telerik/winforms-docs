...
slug: spreadprocessing-working-with-rows-and-columns-what-is-row-column
...
More information about setting row's height and column's width is available in the [Resizing Rows and Columns]({%slug spreadprocessing-working-with-rows-and-columns-resizing%}) article.
