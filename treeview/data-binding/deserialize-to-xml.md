...
>tip For direct access to the tree view XML as text use the __TreeViewXML__ property.
>
...
>tip  __RadTreeView__ supports save/load functionality at design time via the [Property Builder]({%slug winforms/treeview/design-time/property-builder%}).
>
