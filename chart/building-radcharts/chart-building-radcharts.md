...
page_title: Building RadCharts
description: Building RadCharts
slug: chart-building-radcharts
...
To create and populate the __RadChart__ [ChartSeries]({%slug chart-undestanding-radchart-elements-series-overview%}) and [ChartSeriesItem]({%slug chart-undestanding-radchart-elements-series-items%}) collections: 
