...
page_title: Binding to XML at Design-Time using an XMLDataSource
description: Binding to XML at Design-Time using an XMLDataSource
slug: chart-building-radcharts-data-binding-radchart-binding-to-xml-at-design-time-using-an-xmldatasource
