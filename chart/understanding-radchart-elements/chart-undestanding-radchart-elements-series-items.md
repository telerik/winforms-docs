---
title: Series Items
page_title: Series Items
description: Series Items
slug: chart-undestanding-radchart-elements-series-items
tags: series,items
published: True
position: 9
---
...
The key properties are shown in the figure below in the property category "Basic value set". For simple charts along a single axis populate the __YValue______property.  Use the __XValue______property to add a second data dimension. For example, the Y values might be "Sales Volume" and the X values might be time periods or geographic regions.  __XValue2__ and __YValue2______are used by [Gantt]({%slug chart-undestanding-radchart-types-gantt-charts%}) type to indicate a period of time and the [Bubble]({%slug chart-undestanding-radchart-types-bubble-charts%}) chart type to show amplitude of data. 
