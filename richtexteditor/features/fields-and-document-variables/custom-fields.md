...
1. If you like, you can also customize the fragment that is returned when the ResultFragment is requested. This is done by overriding the __GetResultFragment__ method. Here is an example:
