...
* [Telerik UI for WinForms Rating Homepage](https://www.telerik.com/products/winforms/rating.aspx)
* [Get Started with the Telerik UI for WinForms Rating]({%slug winforms/track-and-status-controls/rating/getting-started%})
