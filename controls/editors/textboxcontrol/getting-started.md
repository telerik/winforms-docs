...
This article shows how you can start using **RadTextBoxControl**.

## Adding Telerik Assemblies Using NuGet

To use `RadTextBoxControl` when working with NuGet packages, install the `Telerik.UI.for.WinForms.AllControls` package. The [package target framework version may vary]({%slug winforms-available-nugets%}).
...
## Defining the RadTextBoxControl
