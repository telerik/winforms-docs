...
This article shows how you can start using **RadBrowseEditor**.

## Adding Telerik Assemblies Using NuGet

To use `RadBrowseEditor` when working with NuGet packages, install the `Telerik.UI.for.WinForms.AllControls` package. The [package target framework version may vary]({%slug winforms-available-nugets%}).
...
<snippet id='editors-browseeditor1-browseeditorvaluechanged-cs' />
<snippet id='editors-browseeditor1-browseeditorvaluechanged-vb' />
