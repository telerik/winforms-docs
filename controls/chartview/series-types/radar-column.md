...
<snippet id='chartview-radar-column-radarcolumnseries-cs'/>
<snippet id='chartview-radar-column-radarcolumnseries-vb'/>



The following example shows how you can change the BackColor of particular pieces:

<snippet id='chartview-radar-column-setcolors-cs'/>
<snippet id='chartview-radar-column-setcolors-vb'/>
