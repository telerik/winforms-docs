...
![WinForms RadMenus RadMenu](images/menus-menu-overview001.png)
...
![WinForms RadMenus menus-menu-overview 002](images/menus-menu-overview002.png)

![WinForms RadMenus menus-menu-overview 007](images/menus-menu-overview007.png)
...
![WinForms RadMenus menus-menu-overview 003](images/menus-menu-overview003.png)

* Menu item text displayed in a variety of formats, such as using multi-line text, and vertical or horizontal orientation.
            
![WinForms RadMenus menus-menu-overview 004](images/menus-menu-overview004.png)

![WinForms RadMenus menus-menu-overview 005](images/menus-menu-overview005.png)

* Images can be displayed in the background of the menu as a whole and for each menu item.

![WinForms RadMenus menus-menu-overview 006](images/menus-menu-overview006.png)
