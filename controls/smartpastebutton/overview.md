...
![WF RadSmartPasteButton](images/smart-paste-overview.gif)

## Next Steps

* [Getting Started with Telerik UI for WinForms SmartPasteButton]({%slug smartpastebutton-getting-started%})
