...
The **RadSmartPasteButton** derives from [RadButton]({%slug winforms/buttons/button%}) and supports its standard appearance settings. The following properties customize the content and icon that the button displays before and during a smart paste operation.
...
* [Getting Started with SmartPasteButton]({%slug smartpastebutton-getting-started%})
* [RadButton Features]({%slug winforms/buttons/button%})
