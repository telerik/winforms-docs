...
<snippet id='richtexteditor-commands-init-cs' />
<snippet id='richtexteditor-commands-init-vb' />
...
<snippet id='richtexteditor-commands-event-cs' />
<snippet id='richtexteditor-commands-event-vb' />



Now, the button will respond to the current state of the selection.

![WinForms RadRichTextEditor ToggleBoldCommand](images/richtexteditor-features-clipboard-support001.gif)
