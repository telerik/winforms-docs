...
>important As of **R1 2021** the EditAppointmentDialog provides UI for selecting multiple resources per appointment. The **Resource** RadDropDownList is now changed to RadCheckedDropDownList.
