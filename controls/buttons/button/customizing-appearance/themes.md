...
1. Select __RadButtonElement__ in *Controls Structure* on the left side. Then, select __ButtonFill__ in the *Elements* section.
	...
	![WinForms RadButtons VisualStyleBuilder Select ButtonFill](images/button-customizing-appearance-themes001.png)

1. Modify the applied *fill* repository item. 

	![WinForms RadButtons VisualStyleBuilder Modify ButtonFill](images/button-customizing-appearance-themes002.png)
