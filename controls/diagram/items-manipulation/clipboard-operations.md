...
You can perform these operations in a single form, but you can also copy/cut and paste items between several forms.![WinForms RadDiagram Clipboard Operations](images/diagram-items-manipulation-clipboard-operations001.gif)
