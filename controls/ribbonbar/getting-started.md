...
To use `RadRibbonBar` when working with NuGet packages, install the `Telerik.UI.for.WinForms.AllControls` package. The [package target framework version may vary]({%slug winforms-available-nugets%}).
...
<snippet id='ribbonbar-ribbongettingstarted-boldanditalictext-cs' />
<snippet id='ribbonbar-ribbongettingstarted-boldanditalictext-vb' />
...
* [Telerik UI for WinForms RibbonBar Component](https://www.telerik.com/products/winforms/ribbonbar.aspx)
