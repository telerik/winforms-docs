...
![WinForms RadRibbonBar ribbonbar-getting-started 001](images/ribbonbar-getting-started001.png)
...
> 
> ![WinForms RadRibbonBar ribbonbar-getting-started 013](images/ribbonbar-getting-started013.png)
...
![WinForms RadRibbonBar ribbonbar-getting-started 002](images/ribbonbar-getting-started002.png)

1. Add two more __TabItems__ with captions __Format__ and __Insert:__
![WinForms RadRibbonBar ribbonbar-getting-started 003](images/ribbonbar-getting-started003.png)

## Adding Groups

1. Click the __Format__ tab.

1. Click the __Add New Group...__ button to create a new __RadRibbonBarGroup__. You will be prompted to enter the __Text__ of the new group. Type *Font* and press Enter to confirm the typed __Text__. Do the whole operation again for another group, but set its __Text__ to *Paragraph*. These groups will become containers that you will use to group controls by the type of functionality they have in common:<br>![WinForms RadRibbonBar ribbonbar-getting-started 004](images/ribbonbar-getting-started004.png)<br>![WinForms RadRibbonBar ribbonbar-getting-started 005](images/ribbonbar-getting-started005.png)<br>![WinForms RadRibbonBar ribbonbar-getting-started 006](images/ribbonbar-getting-started006.png)
...
![WinForms RadRibbonBar ribbonbar-getting-started 008](images/ribbonbar-getting-started008.png)

1. Select __RadButtonElement__ from the *drop down* list:
![WinForms RadRibbonBar ribbonbar-getting-started 009](images/ribbonbar-getting-started009.png)

Having done that a __RadButtonElement__ is added to the *button group* that you have just created in the previous steps.
![WinForms RadRibbonBar ribbonbar-getting-started 010](images/ribbonbar-getting-started010.png)  
...
![WinForms RadRibbonBar ribbonbar-getting-started 011](images/ribbonbar-getting-started011.png)
...
![WinForms RadRibbonBar ribbonbar-getting-started 012](images/ribbonbar-getting-started014.gif)
