...
![WinForms RadDock RadDock](images/dock-overview000.png)
...
![WinForms RadDock dock-overview 001](images/dock-overview001.png)
...
* Full drag and drop support including the docking compass and docking hints for visual feedback
    ![WinForms RadDock dock-overview 002](images/dock-overview002.png)

* Tool windows can be "AutoHidden" (collapsed) or pinned open.  

    ![WinForms RadDock dock-overview 003](images/dock-overview003.png)
    ![WinForms RadDock dock-overview 004](images/dock-overview004.png)

* Fully interactive design-time layout management.

    ![WinForms RadDock dock-overview 005](images/dock-overview005.png)

* Ctrl+Tab support for navigating between DockWindows.
 
     ![WinForms RadDock dock-overview 006](images/dock-overview006.png)

* Tabbed documents (DocumentWindows) can be dragged and rearranged within the tabbed document container.

    ![WinForms RadDock dock-overview 007](images/dock-overview007.png)
