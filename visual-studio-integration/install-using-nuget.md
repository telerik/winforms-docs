...
This article explains how to [install the Telerik UI for WinForms suite using NuGet packages](https://www.youtube.com/embed/c3m_BLMXNDk). Before installing, you need to [Generate an API Key](#generate-an-api-key). There are two methods available for obtaining the NuGet packages:
