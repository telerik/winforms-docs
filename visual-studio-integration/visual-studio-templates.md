...
![Visual Studio New Project dialog showing Telerik UI for WinForms templates](images/visual-studio-templates001.png)
...
![Telerik UI for WinForms Word-Inspired project template with rich text editing controls](images/visual-studio-templates002.png)
...
![Telerik UI for WinForms Outlook-Inspired Mail project template](images/visual-studio-templates003.png)
...
![Telerik UI for WinForms Outlook-Inspired Calendar project template](images/visual-studio-templates004.png)
...
![Telerik UI for WinForms Excel-Inspired project template with spreadsheet editing controls](images/visual-studio-templates005.png)
# See Also
