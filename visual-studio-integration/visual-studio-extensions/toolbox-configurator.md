...
![Visual Studio Telerik menu with the Telerik UI for WinForms Toolbox Configuration command](images/installation-deployment-and-distribution-vsx-toolbox-configurator001.png)
...
![Telerik UI for WinForms Toolbox Configurator version selection page](images/installation-deployment-and-distribution-vsx-toolbox-configurator002.png)
...
![Telerik UI for WinForms Toolbox Configurator completion screen before restarting Visual Studio](images/installation-deployment-and-distribution-vsx-toolbox-configurator003.png)
