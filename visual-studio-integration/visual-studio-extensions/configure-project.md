...
![Telerik UI for WinForms Project Configuration Wizard opened from the Visual Studio Telerik menu](images/installation-deployment-and-distribution-vsx-configure-project000.png)
...
![Telerik UI for WinForms Project Configuration Wizard assembly selection page](images/installation-deployment-and-distribution-vsx-configure-project001.png)
...
![Telerik UI for WinForms Project Configuration Wizard theme selection page](images/installation-deployment-and-distribution-vsx-configure-project002.png)
...
![Telerik UI for WinForms Project Configuration Wizard high DPI support option](images/installation-deployment-and-distribution-vsx-configure-project003.png)
