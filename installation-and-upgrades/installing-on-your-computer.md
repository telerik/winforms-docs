...
![Telerik UI for WinForms installer checking installed Visual Studio and .NET versions](images/installation-deployment-and-distribution-installing-on-your-computer002.png)

5\. You can use the __Customize__ button to choose which features will be installed and the installation path.                
            
![Telerik UI for WinForms installer customization screen for selecting features and installation path](images/installation-deployment-and-distribution-installing-on-your-computer003.png)
...
![Telerik UI for WinForms installer showing control installation progress](images/installation-deployment-and-distribution-installing-on-your-computer004.png)
