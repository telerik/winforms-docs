...
**Telerik Upgrade API Analyzer** is a **ClickOnce** application and you can download the installation file directly from the [Telerik Upgrade API Analyzer download page](http://demos.telerik.com/UpgradeAPIAnalyzer/setup.exe).
...
![Upgrade Project Wizard Compatibility button that opens the Telerik Upgrade API Analyzer.](images/upgrade-api-analyzer_5.png)
...
![Telerik Upgrade API Analyzer listing API differences between Telerik versions.](images/upgrade-api-analyzer_2.png)
