...
This article explains how to install the Telerik UI for WinForms suite using NuGet packages. You can obtain the NuGet packages in one of the following ways:
