...
__ListViewSpreadExport__ utilizes our [RadSpreadProcessing]({%slug winforms/spread-processing%})  libraries to export the contents of __RadListView__ to *xlsx, csv, pdf* and *txt* formats. The list view is exported according to the current ViewType. All three view types can be exported. This article will explain in detail the SpreadExport abilities and will demonstrate how you can use it.
