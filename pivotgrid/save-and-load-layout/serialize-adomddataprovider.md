...
In this article we will show you how to serialize and deserialize __AdomdDataProvider__ and all of its settings. You can use this feature to save the current state of the provider and load it next when time the application is started.
