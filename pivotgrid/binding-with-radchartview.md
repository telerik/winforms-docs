...
{{region SetDataSource}}
	        ...
	        AddHandler Me.radPivotGrid1.ChartDataProvider.SeriesCreating, AddressOf ChartDataProvider_SeriesCreating
	        AddHandler Me.radPivotGrid1.ChartDataProvider.UpdateCompleted, AddressOf ChartDataProvider_UpdateCompleted
	
	    End Sub
	
	#Region "replaceOrModifySeries"
	...
	#End Region
	    ...
	    Private Sub PivotGridBindingWithChart_Load(sender As Object, e As EventArgs) Handles Me.Load
