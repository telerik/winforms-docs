...
Progress&reg; Telerik&reg; UI for WinForms allows you to create a simple coded UI test using MSAA in a few mouse clicks. An example is available [here]({%slug winforms/codedui/getting-started%}).
