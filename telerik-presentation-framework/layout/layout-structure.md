...
![Telerik UI for WinForms Telerik Presentation Framework box model diagram showing content, padding, border, and margin](images/Structure001.png)
...
![Telerik UI for WinForms Telerik Presentation Framework margin comparison for controls with and without margins](images/Structure002.png)
