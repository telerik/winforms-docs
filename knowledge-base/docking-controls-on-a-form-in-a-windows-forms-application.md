...
![Telerik UI for WinForms form layout with RadDock overlapping the RadStatusStrip because of docking order.](Images/dockstatusoverlapping.png)  
...
![Visual Studio Document Outline showing incorrect control order for a Telerik UI for WinForms docking layout.](Images/dockstatusoverlappingOutline.png)  
...
![Visual Studio Document Outline showing correct control order for a Telerik UI for WinForms docking layout.](Images/dockstatusokOutline.png)  
   
In this case, we will get the desired layout. The result is shown on the screenshot below:   
   
![Telerik UI for WinForms form layout with RadDock docked correctly between RadMenu and RadStatusStrip.](Images/dockstatusok.png)
