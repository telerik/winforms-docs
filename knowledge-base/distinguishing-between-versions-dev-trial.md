...
![Telerik UI for WinForms trial examples application home screen showing the Purchase button.](images/ExamplesPurchaseButtonQ2013.png)  
...
![Telerik UI for WinForms trial assemblies shown in the installation Bin folder.](images/TrialFolderView1.png)  
#### Figure 1: Trial assemblies view in the Bin folder
   
![Telerik UI for WinForms trial assembly properties showing the Trial Version description.](images/TrialAssemblyDescriptionView1.png)  
#### Figure 2: Properties window of Trial assemblies 
   
![Telerik UI for WinForms trial assemblies in the Visual Studio Add Reference .NET tab.](images/TrialNetView.png)  
...
![Telerik UI for WinForms trial popup message window.](images/TrialMessageBoxQ2013.png)  
