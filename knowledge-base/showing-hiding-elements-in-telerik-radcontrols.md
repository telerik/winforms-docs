...
![Telerik UI for WinForms RadRibbonBar Font chunk with all elements visible.](images/RibbonBar_AllVisible.png)   
 ...
 **SOLUTION 1** -  Show or hide only the needed element without effecting other elements (even the element's children).  
 ...
 ![Telerik UI for WinForms RadRibbonBar Font chunk with the fill primitive hidden by ShouldPaint.](images/RibbonBar_NoFill.PNG)   
 ...
 **SOLUTION 2** - Show or hide the element along with its children   
 ...
 ![Telerik UI for WinForms RadRibbonBar Font chunk with the fill primitive hidden by Visibility.Hidden.](images/RibbonBar_HiddenFill.PNG)   
 ...
 **SOLUTION 3** - Show or hide the element by affecting the siblings (via the layout mechanism)   
 ...
 ![Telerik UI for WinForms RadRibbonBar Font chunk with the fill primitive collapsed by Visibility.Collapsed.](images/RibbonBar_CollapsedFill.PNG)
